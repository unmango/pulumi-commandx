...
export class Wget extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'commandx:remote:Wget';
     ...
     */
    public readonly create!: pulumi.Output<string | outputs.remote.WgetOpts | undefined>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    public readonly delete!: pulumi.Output<string | outputs.remote.WgetOpts | undefined>;
    /**
     ...
     */
    public readonly update!: pulumi.Output<string | outputs.remote.WgetOpts | undefined>;
...
export interface WgetArgs {
     ...
     * The command to run on create.
     */
    create?: pulumi.Input<string> | pulumi.Input<inputs.remote.WgetOptsArgs>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    delete?: pulumi.Input<string> | pulumi.Input<inputs.remote.WgetOptsArgs>;
    /**
     * Environment variables
     */
     ...
     * create or update steps.
     */
    update?: pulumi.Input<string> | pulumi.Input<inputs.remote.WgetOptsArgs>;
}
