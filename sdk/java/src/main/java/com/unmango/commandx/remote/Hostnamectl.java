...
import com.unmango.commandx.remote.HostnamectlArgs;
import com.unmango.commandx.remote.outputs.HostnamectlOpts;
 ...
 * 
 */
@ResourceType(type="commandx:remote:Hostnamectl")
public class Hostnamectl extends com.pulumi.resources.ComponentResource {
     ...
     * 
     */
    @Export(name="create", refs={Either.class,String.class,HostnamectlOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,HostnamectlOpts>> create;

    /**
     * @return The command to run on create.
     * 
     */
    public Output<Optional<Either<String,HostnamectlOpts>>> create() {
     ...
     * 
     */
    @Export(name="delete", refs={Either.class,String.class,HostnamectlOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,HostnamectlOpts>> delete;
     ...
     * 
     */
    public Output<Optional<Either<String,HostnamectlOpts>>> delete() {
     ...
     * 
     */
    @Export(name="update", refs={Either.class,String.class,HostnamectlOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,HostnamectlOpts>> update;
     ...
     * 
     */
    public Output<Optional<Either<String,HostnamectlOpts>>> update() {
    ...
    public Hostnamectl(String name, HostnamectlArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("commandx:remote:Hostnamectl", name, args == null ? HostnamectlArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
