...
import com.unmango.commandx.remote.RmArgs;
import com.unmango.commandx.remote.outputs.RmOpts;
 ...
 * 
 */
@ResourceType(type="commandx:remote:Rm")
public class Rm extends com.pulumi.resources.ComponentResource {
     ...
     * 
     */
    @Export(name="create", refs={Either.class,String.class,RmOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,RmOpts>> create;

    /**
     * @return The command to run on create.
     * 
     */
    public Output<Optional<Either<String,RmOpts>>> create() {
     ...
     * 
     */
    @Export(name="delete", refs={Either.class,String.class,RmOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,RmOpts>> delete;
     ...
     * 
     */
    public Output<Optional<Either<String,RmOpts>>> delete() {
     ...
     * 
     */
    @Export(name="update", refs={Either.class,String.class,RmOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,RmOpts>> update;
     ...
     * 
     */
    public Output<Optional<Either<String,RmOpts>>> update() {
    ...
    public Rm(String name, RmArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("commandx:remote:Rm", name, args == null ? RmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
