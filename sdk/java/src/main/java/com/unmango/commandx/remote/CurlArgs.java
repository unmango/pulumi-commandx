...
import com.unmango.commandx.remote.inputs.CurlOptsArgs;
...
public final class CurlArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="create")
    private @Nullable Either<String,CurlOptsArgs> create;

    /**
     * @return The command to run on create.
     * 
     */
    public Optional<Either<String,CurlOptsArgs>> create() {
     ...
     */
    @Import(name="delete")
    private @Nullable Either<String,CurlOptsArgs> delete;
     ...
     * 
     */
    public Optional<Either<String,CurlOptsArgs>> delete() {
     ...
     */
    @Import(name="update")
    private @Nullable Either<String,CurlOptsArgs> update;
     ...
     * 
     */
    public Optional<Either<String,CurlOptsArgs>> update() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder create(@Nullable Either<String,CurlOptsArgs> create) {
            $.create = create;
            return this;
        }
         ...
         * 
         */
        public Builder delete(@Nullable Either<String,CurlOptsArgs> delete) {
            $.delete = delete;
            return this;
        }
         ...
         * 
         */
        public Builder update(@Nullable Either<String,CurlOptsArgs> update) {
            $.update = update;
            return this;
        }
