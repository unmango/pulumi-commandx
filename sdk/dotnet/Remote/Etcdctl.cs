...
namespace UnMango.Commandx.Remote
{
    ...
    /// </summary>
    [CommandxResourceType("commandx:remote:Etcdctl")]
    public partial class Etcdctl : global::Pulumi.ComponentResource
    {
        ...
        /// </summary>
        [Output("create")]
        public Output<Union<string, Outputs.EtcdctlOpts>?> Create { get; private set; } = null!;
        ...
        /// </summary>
        [Output("delete")]
        public Output<Union<string, Outputs.EtcdctlOpts>?> Delete { get; private set; } = null!;
        ...
        /// </summary>
        [Output("update")]
        public Output<Union<string, Outputs.EtcdctlOpts>?> Update { get; private set; } = null!;
        ...
        public Etcdctl(string name, EtcdctlArgs args, ComponentResourceOptions? options = null)
            : base("commandx:remote:Etcdctl", name, args ?? new EtcdctlArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class EtcdctlArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("create")]
        public Union<Input<string>, Inputs.EtcdctlOptsArgs>? Create { get; set; }
        ...
        /// </summary>
        [Input("delete")]
        public Union<Input<string>, Inputs.EtcdctlOptsArgs>? Delete { get; set; }
        ...
        /// </summary>
        [Input("update")]
        public Union<Input<string>, Inputs.EtcdctlOptsArgs>? Update { get; set; }
