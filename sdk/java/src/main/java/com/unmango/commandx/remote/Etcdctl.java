...
import com.unmango.commandx.remote.EtcdctlArgs;
import com.unmango.commandx.remote.outputs.EtcdctlOpts;
 ...
 * 
 */
@ResourceType(type="commandx:remote:Etcdctl")
public class Etcdctl extends com.pulumi.resources.ComponentResource {
    ...
    public Etcdctl(String name, EtcdctlArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("commandx:remote:Etcdctl", name, args == null ? EtcdctlArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
