...
import com.unmango.commandx.remote.MktempArgs;
import com.unmango.commandx.remote.outputs.MktempOpts;
 ...
 * 
 */
@ResourceType(type="commandx:remote:Mktemp")
public class Mktemp extends com.pulumi.resources.ComponentResource {
     ...
     * 
     */
    @Export(name="create", refs={Either.class,String.class,MktempOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,MktempOpts>> create;

    /**
     * @return The command to run on create.
     * 
     */
    public Output<Optional<Either<String,MktempOpts>>> create() {
     ...
     * 
     */
    @Export(name="delete", refs={Either.class,String.class,MktempOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,MktempOpts>> delete;
     ...
     * 
     */
    public Output<Optional<Either<String,MktempOpts>>> delete() {
     ...
     * 
     */
    @Export(name="update", refs={Either.class,String.class,MktempOpts.class}, tree="[0,1,2]")
    private Output</* @Nullable */ Either<String,MktempOpts>> update;
     ...
     * 
     */
    public Output<Optional<Either<String,MktempOpts>>> update() {
    ...
    public Mktemp(String name, MktempArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("commandx:remote:Mktemp", name, args == null ? MktempArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
