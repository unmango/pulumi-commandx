...
export class Mktemp extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'commandx:remote:Mktemp';
     ...
     */
    public readonly create!: pulumi.Output<string | outputs.remote.MktempOpts | undefined>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    public readonly delete!: pulumi.Output<string | outputs.remote.MktempOpts | undefined>;
    /**
     ...
     */
    public readonly update!: pulumi.Output<string | outputs.remote.MktempOpts | undefined>;
