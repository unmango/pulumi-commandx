...
import com.unmango.commandx.remote.TarArgs;
import com.unmango.commandx.remote.outputs.TarOpts;
 ...
 * 
 */
@ResourceType(type="commandx:remote:Tar")
public class Tar extends com.pulumi.resources.ComponentResource {
    ...
    public Tar(String name, TarArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("commandx:remote:Tar", name, args == null ? TarArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
