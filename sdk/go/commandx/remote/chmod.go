...
// The underlying command
func (o ChmodOutput) Command() remote.CommandOutput {
	return o.ApplyT(func(v *Chmod) remote.CommandOutput { return v.Command }).(remote.CommandOutput)
}

// Connection details for the remote system
func (o ChmodOutput) Connection() remote.ConnectionOutput {
	return o.ApplyT(func(v *Chmod) remote.ConnectionOutput { return v.Connection }).(remote.ConnectionOutput)
}
