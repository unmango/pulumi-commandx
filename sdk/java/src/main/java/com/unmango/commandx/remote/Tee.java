...
import com.unmango.commandx.remote.TeeArgs;
import com.unmango.commandx.remote.outputs.TeeOpts;
 ...
 * 
 */
@ResourceType(type="commandx:remote:Tee")
public class Tee extends com.pulumi.resources.ComponentResource {
    ...
    public Tee(String name, TeeArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("commandx:remote:Tee", name, args == null ? TeeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
