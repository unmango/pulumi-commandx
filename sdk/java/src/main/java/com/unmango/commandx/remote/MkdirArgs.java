...
import com.unmango.commandx.remote.inputs.MkdirOptsArgs;
...
public final class MkdirArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="create")
    private @Nullable Either<String,MkdirOptsArgs> create;

    /**
     * @return The command to run on create.
     * 
     */
    public Optional<Either<String,MkdirOptsArgs>> create() {
     ...
     */
    @Import(name="delete")
    private @Nullable Either<String,MkdirOptsArgs> delete;
     ...
     * 
     */
    public Optional<Either<String,MkdirOptsArgs>> delete() {
     ...
     */
    @Import(name="update")
    private @Nullable Either<String,MkdirOptsArgs> update;
     ...
     * 
     */
    public Optional<Either<String,MkdirOptsArgs>> update() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder create(@Nullable Either<String,MkdirOptsArgs> create) {
            $.create = create;
            return this;
        }
         ...
         * 
         */
        public Builder create(MkdirOptsArgs create) {
         ...
         * 
         */
        public Builder delete(@Nullable Either<String,MkdirOptsArgs> delete) {
            $.delete = delete;
            return this;
        }
         ...
         * 
         */
        public Builder delete(MkdirOptsArgs delete) {
         ...
         * 
         */
        public Builder update(@Nullable Either<String,MkdirOptsArgs> update) {
            $.update = update;
            return this;
        }
         ...
         * 
         */
        public Builder update(MkdirOptsArgs update) {
