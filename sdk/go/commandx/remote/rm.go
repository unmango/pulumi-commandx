...
// The underlying command
func (o RmOutput) Command() remote.CommandOutput {
	return o.ApplyT(func(v *Rm) remote.CommandOutput { return v.Command }).(remote.CommandOutput)
}

// Connection details for the remote system
func (o RmOutput) Connection() remote.ConnectionOutput {
	return o.ApplyT(func(v *Rm) remote.ConnectionOutput { return v.Connection }).(remote.ConnectionOutput)
}
