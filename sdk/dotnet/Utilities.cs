...
namespace UnMango.Commandx
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("UnMango.Commandx.version.txt");
    ...
    internal sealed class CommandxResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CommandxResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
