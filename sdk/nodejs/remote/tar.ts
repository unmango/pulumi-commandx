...
export class Tar extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'commandx:remote:Tar';
     ...
     */
    public readonly create!: pulumi.Output<string | outputs.remote.TarOpts | undefined>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    public readonly delete!: pulumi.Output<string | outputs.remote.TarOpts | undefined>;
    /**
     ...
     */
    public readonly update!: pulumi.Output<string | outputs.remote.TarOpts | undefined>;
...
export interface TarArgs {
     ...
     * The command to run on create.
     */
    create?: pulumi.Input<string> | pulumi.Input<inputs.remote.TarOptsArgs>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    delete?: pulumi.Input<string> | pulumi.Input<inputs.remote.TarOptsArgs>;
    /**
     * Environment variables
     */
     ...
     * create or update steps.
     */
    update?: pulumi.Input<string> | pulumi.Input<inputs.remote.TarOptsArgs>;
}
