...
export class Tee extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'commandx:remote:Tee';
     ...
     */
    public readonly create!: pulumi.Output<string | outputs.remote.TeeOpts | undefined>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    public readonly delete!: pulumi.Output<string | outputs.remote.TeeOpts | undefined>;
    /**
     ...
     */
    public readonly update!: pulumi.Output<string | outputs.remote.TeeOpts | undefined>;
...
export interface TeeArgs {
     ...
     * The command to run on create.
     */
    create?: pulumi.Input<string> | pulumi.Input<inputs.remote.TeeOptsArgs>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    delete?: pulumi.Input<string> | pulumi.Input<inputs.remote.TeeOptsArgs>;
    /**
     * Environment variables
     */
     ...
     * create or update steps.
     */
    update?: pulumi.Input<string> | pulumi.Input<inputs.remote.TeeOptsArgs>;
}
