...
// The underlying command
func (o SedOutput) Command() remote.CommandOutput {
	return o.ApplyT(func(v *Sed) remote.CommandOutput { return v.Command }).(remote.CommandOutput)
}

// Connection details for the remote system
func (o SedOutput) Connection() remote.ConnectionOutput {
	return o.ApplyT(func(v *Sed) remote.ConnectionOutput { return v.Connection }).(remote.ConnectionOutput)
}
